...
function calculateRatio() {
    ...
    // Calculating hit ratio = (number of hits / total references) * 100
    ...
    // This is another method to print the output
    // output2 += `<p>The Hit Ratio is: ${hit_ratio}%</p>`;
    // output2 += `<p>The Miss Ratio is: ${miss_ratio}%</p>`;
